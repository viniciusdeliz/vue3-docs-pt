...
## `v-for` sobre `<template>` {#v-for-on-template}
...
### Substituindo um _Array_ {#replacing-an-array}
...
## Exibindo Resultados Filtrados/Organizados {#displaying-filtered-sorted-results}
